...
<body>
        ...
        <div class="max-width">
            ...
            <div class="about-content">
                <div class="column left">
                    <img src="../php/u/is.jpg" alt="">
                </div>
                <div class="column right">
                    <div class="text">I'm a Rakib ul I'm a <span class="typing-2"></span></div>
        ...
        <div class="max-width">
            ...
            <div class="skills-content">
                <div class="column left">
                    ...
                    <p> Innovative, task-driven professional
                        ...
                        features based on user feedback.</p>
                    <a href="#">Read more</a>
                </div>
                <div class="column right">
                    <div class="bars">
    ...
    <section class="teams" id="teams">
        <div class="max-width">
            ...
            <div class="carousel owl-carousel">
                ...
                <div class="card">
                    <div class="box">
                        <img src="../php/u/rak.jpg" alt="">
                        <div class="text">_____________</div>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                    </div>
                </div>
                <div class="card">
                    ...
                    <div class="icons">
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">Rakib ul</div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">rakibul532502@gmail.com</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <footer>
        <span>Created By <a href="https://www.codingnepalweb.com">Coding Dhaka Bangladesh</a> | <span
